...
def summarize_order(order):
    ...
    ### WRITE SOLUTION HERE
    total = 0
    subtotal = float(calculate_subtotal(order))
...
def main():
    order = take_order()
    print("The order is:", [item["name"] for item in order])
    ...
    print("Items in order: ", items)
    print("Total cost of order (including tax): ", total)
